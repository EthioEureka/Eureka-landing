        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs font-mono text-eureka-slate mt-1 font-semibold">
              Add a core capability offered by Ethio-Eureka agency
            </p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white border border-eureka-border rounded-3xl p-6 md:p-8 shadow-eureka-lg font-sans text-xs">
        ...
        <div>
          ...
          <input
            type="text"
            required
            placeholder="High-performance web applications built with Next.js & Tailwind CSS"
        ...
        <div>
          ...
          <textarea
            required
            rows={5}
            placeholder="Detailed description of deliverables, technology stack, and business benefits..."
