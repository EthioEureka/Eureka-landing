...
export const defaultSiteSettings: SiteSettings = {
  ...
  description:
    "Ethio-Eureka is an independent creative technology and digital studio.",
  email: "",
  phone: "",
  location: "",
  address: "",
  ...
  meta_description:
    "Ethio-Eureka is a creative digital studio helping ambitious businesses build brands, websites, and digital experiences.",
};
